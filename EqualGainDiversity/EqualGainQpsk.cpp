...
int main(){
    ...
    for(int step = 0; step<energyOfSymbol.size(); step++){
        ...
        transmittedSymbol1 = SignalVectors1(Symbols, energyOfSymbol[step]);
        transmittedSymbol2 = SignalVectors2(Symbols, energyOfSymbol[step]);
